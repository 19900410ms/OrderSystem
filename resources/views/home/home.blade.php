...
<div class="container">
  <div class="card-columns">
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/meat.jpg') }}" height="220px" width="100%" alt="Meats">
      <div class="card-body">
    ...
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/fish.jpg') }}" height="220px" width="100%" alt="Fishes">
      <div class="card-body">
    ...
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/salada.jpg') }}" height="220px" width="100%" alt="Saladas">
      <div class="card-body">
  ...
  <div class="card-columns">
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/drink.jpg') }}" height="220px" width="100%" alt="Drinks">
      <div class="card-body">
    ...
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/sweet.jpg') }}" height="220px" width="100%" alt="Sweets">
      <div class="card-body">
    ...
    <div class="card">
      <img class="card-img-top" src="{{ asset('/img/other.jpg') }}" height="220px" width="100%" alt="the Others">
      <div class="card-body">
